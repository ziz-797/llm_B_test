...
由 `update_prices.py` 于 2026-09-10T02:53:31 自动生成。
...
| DeepInfra | https://deepinfra.com/models | `https://api.deepinfra.com/models/list` | 公开 API | ✅ | 213 |
...
| LiteLLM | https://github.com/BerriAI/litellm | `https://cdn.jsdelivr.net/gh/BerriAI/litellm@main/model_prices_and_cont` | MIT | ✅ | 2800 |
| models.dev | https://models.dev | `https://models.dev/api.json` | MIT | ✅ | 6055 |
...
| OpenRouter | https://openrouter.ai/models | `https://openrouter.ai/api/v1/models` | 公开 API | ✅ | 346 |
