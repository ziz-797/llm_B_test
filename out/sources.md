...
由 `update_prices.py` 于 2026-08-28T08:50:14 自动生成。
...
| models.dev | https://models.dev | `https://models.dev/api.json` | MIT | ✅ | 5912 |
...
| OpenRouter | https://openrouter.ai/models | `https://openrouter.ai/api/v1/models` | 公开 API | ✅ | 299 |
